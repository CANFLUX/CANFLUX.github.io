...
![Distribution of Canadian flux sites for which ecosystem/vegetation is known (111), currently based upon the [Ameriflux IGBP definitions](https://ameriflux.lbl.gov/data/badm/badm-standards/IGBP){target="_blank"}](./images/distribution_flux_sites_canada.png){fig-align="center"}
