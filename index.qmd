...
# CanFlux: Canada's Network for Ecosystem–Climate Interactions
...
* *CanFlux will develop a sovereign, community-governed data platform integrating greenhouse gas, water, and energy flux data with associated meteorological and hydrological measurements.*
  ...
  By compiling, processing, and storing data from at least 174 recently identified historical and active flux sites across Canada. Our CanFlux Sites interactive map shows flux towers for which coordinates are also known (166). 
    ...
    <a href="https://rshiny.geog.mcgill.ca/knox/canflux/" target="_blank">View site information in separate window</a>.
